...
\begin{figure}[h]
  ...
  \captiondesc{The first two \enquote{unconfirmed} employees can
  confirm their verification with the principle verifier or
  through the \enquote{confirmed} employee. The final
  \enquote{unconfirmed} employee is attempting to confirm with
  an another unconfirmed employee --- illegal.}
