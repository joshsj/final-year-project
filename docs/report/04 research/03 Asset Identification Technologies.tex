...
supermarket till with \labelref{ss:barcodes}{barcodes},
using \labelref{ss:nfc}{NFC} to pay for shopping using
contactless payment, or protecting said items against theft
using \labelref{ss:rfid}{RFID}-based security tags.
...
\labelref{ss:biometrics}{biometrics}; 90\% of new phones
...
\labelref{ss:goal}{desired flexibility}. 
